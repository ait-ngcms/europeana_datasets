...
public class EvaluationDatasetBuilderTest extends ThumbnailsForCollectionAccessorTest {
	...
	public void createDemoDataset() throws IOException, EuropeanaApiProblem {
		...
		//1
		buildArtPaintingImageSet();

//		//2
		buildArtPosterImageSet();
		
//		//3
		buildArtManuscriptImageSet();

//		//4
		buildArtTapestryImageSet();

//		//5
		buildArtSculptureImageSet();
		
//		//6
		buildArtCarpetImageSet();
		
//		//7
		buildArtJapanPrintImageSet();
		
//		//8
		buildObjectPorcelainImageSet();
				
//		//9
		buildObjectJewelleryImageSet();
		
//		//10
		buildObjectShoesImageSet();
		
//		//11
		buildObjectHeadGearImageSet();
		
//		//12
		buildFashionDrawingSet();

//		//13
		buildObjectMusicInstrumentImageSet();
//		
